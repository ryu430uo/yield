...
export const YourBalanceCard = () => {
  ...
  return (
    <Card className="nested-card">
      ...
      <Card.Secondary>{formatNumber(balance, 2)} MEDUSA</Card.Secondary>
    </Card>
  );
};
...
export const YourEarningsCard = () => {
  ...
  return (
    <Card className="nested-card green">
      ...
      <Card.Secondary>{formatNumber(balance * 0.020999, 2)} MEDUSA</Card.Secondary>
    </Card>
  );
};
...
export const NextRewardAmountCard = () => {
  ...
  return (
    <Card className="long-card">
      <Card.Right>{!isAccountLoading && formatNumber(balance * 0.0004148125, 2)} MEDUSA</Card.Right>
