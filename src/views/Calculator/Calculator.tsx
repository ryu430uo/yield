...
function Calculator() {
  ...
  const [rewardYield, setRewardYield] = useState(100000.0);
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="calculator-card-apy">
                      <p className="calculator-card-metrics-title">YIELD Price</p>
                    ...
                    <div className="calculator-card-tvl">
                      ...
                      <p className="calculator-card-metrics-value">
                        {isAppLoading ? (
                          ...
                          <>{new Intl.NumberFormat("en-US").format(rewardYield)}%</>
                        )}
                      </p>
                    </div>
                  </Grid>
                  <Grid item xs={6} sm={4} md={4} lg={4}>
                    <div className="calculator-card-index">
                      <p className="calculator-card-metrics-title">Your YIELD Balance</p>
                      <p className="calculator-card-metrics-value">
                        {isAppLoading ? <Skeleton width="100px" /> : <>{titanoAmount.toFixed(2)} YIELD</>}
                      </p>
                    </div>
                  </Grid>
                </Grid>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">YIELD Amount</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          ...
                          endAdornment={
                            <InputAdornment position="end">
                              <div
                                onClick={() => setTitanoAmount(titanoAmount)}
                    ...
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">YIELD price at purchase ($)</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                          ...
                          endAdornment={
                            <InputAdornment position="end">
                              <div
                                onClick={() => setPriceAtPurchase(marketPrice)}
                                className="stake-card-action-input-btn"
                              >
                                <p>Current</p>
                              </div>
                    ...
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">Future YIELD market price ($)</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                          ...
                          endAdornment={
                            <InputAdornment position="end">
                              <div
                                onClick={() => setFutureMarketPrice(marketPrice)}
                                className="stake-card-action-input-btn"
                              >
                                <p>Current</p>
                              </div>
                ...
                <div className="calculator-user-data">
                  <div className="data-row">
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>${initialInvestment.toFixed(2)}</>}
                    </p>
                    <p className="data-row-name">Your initial investment</p>
                  </div>
                  <div className="data-row">
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>${calcCurrentWealth().toFixed(2)}</>}
                    </p>
                    <p className="data-row-name">Current Balance</p>
                  </div>
                  <div className="data-row">
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation.toFixed(2)} YIELD</>}
                    </p>
                    <p className="data-row-name">YIELD rewards estimation</p>
                  </div>
                  <div className="data-row">
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>${potentialReturn.toFixed(2)}</>}
                    </p>
                    <p className="data-row-name">Potential return</p>
                  </div>
                  <div className="data-row">
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>{Math.floor(Number(potentialReturn) / 10000)}</>}
                    </p>
